...
st.write(f"Emplyees in region {region}, {age} years old, with {years_exp} years of experience, the male worker earns ${} more than the female worker annually.".format(float(wage_diff)))
